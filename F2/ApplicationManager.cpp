...
void ApplicationManager::ExecuteAction(ActionType ActType) 
{
	...
	case TO_PLAY_MODE:
		pAct = new SwitchToPlayAction(this); // temporary till you made its action class (CHANGE THIS LATTER)
		break;
	...
	case INPUT_DICE:
		...
		break;
	case TO_DESIGN_MODE:
		pAct = new SwitchToDesignAction(this); // temporary till you made its action class (CHANGE THIS LATTER)
		break;
