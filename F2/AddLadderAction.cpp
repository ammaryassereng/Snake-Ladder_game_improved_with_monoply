...
{	
	...
	{
		pGrid->PrintErrorMessage("end cell must be above start cell");
	}
	if (pGrid->GetSnakeFromPosition(endPos) != NULL)
	{
		pGrid->PrintErrorMessage("End position can't be the start of a Snake");
	}
